...
if (true) {
    ...
    $response = obtenerAgenciasPorProfile($conn,$profile);
...
function obtenerAgenciasPorProfile($conn,$profile)
{
    ...
    $stmtobtenerAgencias = $conn->prepare("call spobtenerAgenciasPorProfile(?);");
    mysqli_stmt_bind_param($stmtobtenerAgencias, 's',$profile);
