...
$queryEmpleadosPorAgencia = "SELECT tu.id,tu.nickname, tu.name,tu.lastName,tu.lastNameOp, tu.email,trur.idRol
FROM user AS tu
...
$resultEmployees->bind_result($id, $nickname, $name, $lastName,$lastNameOp,$email,$idRol);
