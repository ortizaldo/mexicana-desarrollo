...
isset($_POST["idReporte"])
    ...
    if ($CodigoRespuesta == 0) {
        ...
        $estatusSegundaVenta = $response["estatusSegundaVenta"];
        ...
        $permisosDelProceso = generarDropDownEnBaseAPermisos($response);
...
function generarDropDownEnBaseAPermisos($response)
{
