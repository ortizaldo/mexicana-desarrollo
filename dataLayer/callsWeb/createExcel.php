        ...
        switch ($value['datosGrales']["name"]) {
            ...
            case 'Instalacion':
                if ($value['datosGrales']['estatusReporte'] == 'EN PROCESO') {
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A' . $i, $value['datosGrales']["id"])
                                ...
                                ->setCellValue('I' . $i, $value['datosGrales']["nicknameEmpleado"])
                                ->setCellValue('J' . $i, $value['datosGrales']["nicknameAgencia"])
                                ->setCellValue('CC' . $i, $value['installation']['phLabel'])
            ...
            case 'Segunda Venta':
                ...
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A' . $i, $value['datosGrales']["id"])
                            ...
                            ->setCellValue('I' . $i, $value['datosGrales']["nicknameEmpleado"])
                            ->setCellValue('J' . $i, $value['datosGrales']["nicknameAgencia"])
                            ->setCellValue('AM' . $i, $value['formSegVta']['payment_agrr'])
                            ->setCellValue('AN' . $i, $value['datosGrales']['agreementNumber'])
                            ->setCellValue('AO' . $i, $value['formSegVta']['requestDate_agrr'])
                            ->setCellValue('AP' . $i, $value['formSegVta']['clientName_agrr'])
                            ->setCellValue('AQ' . $i, $value['formSegVta']['clientlastName2_agrr'])
                            ->setCellValue('AR' . $i, $value['formSegVta']['clientlastName_agrr'])
                            ->setCellValue('AS' . $i, $value['formSegVta']['clientRFC_agrr'])
                            ->setCellValue('AT' . $i, $value['formSegVta']['clientCURP_agrr'])
                            ->setCellValue('AU' . $i, $value['formSegVta']['clientEmail_agrr'])
                            ->setCellValue('AV' . $i, $value['formSegVta']['clientgender_agrr'])
                            ->setCellValue('AW' . $i, $value['formSegVta']['clientRelationship_agrr'])
                            ->setCellValue('AX' . $i, $value['formSegVta']['identificationType_agrr'])
                            ->setCellValueExplicit('AY' . $i, $clientIdNumber_agrr, PHPExcel_Cell_DataType::TYPE_STRING)
                            ->setCellValue('AZ' . $i, $value['formSegVta']['clientBirthDate_agrr'])
                            ->setCellValue('BA' . $i, $value['formSegVta']['clientBirthCountry_agrr'])
                            ->setCellValue('BB' . $i, $value['formSegVta']['idState_agrr'])
                            ->setCellValue('BC' . $i, $value['formSegVta']['idCity_agrr'])
                            ->setCellValue('BD' . $i, $value['formSegVta']['idColonia_agrr'])
                            ->setCellValue('BE' . $i, $value['formSegVta']['street_agrr'])
                            ->setCellValue('BF' . $i, $value['formSegVta']['street_agrr'])
                            ->setCellValue('BG' . $i, $value['formSegVta']['inHome_agrr'])
                            ...
                            ->setCellValue('BJ' . $i, $value['formSegVta']['clientJobEnterprise_agrr'])
                            ->setCellValue('BK' . $i, $value['formSegVta']['clientJobRange_agrr'])
                            ->setCellValue('BL' . $i, $value['formSegVta']['clientJobLocation_agrr'])
                            ->setCellValueExplicit('BM' . $i, $clientJobTelephone_agrr, PHPExcel_Cell_DataType::TYPE_STRING)
                            ->setCellValue('BN' . $i, $value['formSegVta']['clientJobActivity_agrr'])
                            ->setCellValue('BO' . $i, $value['formSegVta']['agreementType_agrr'])
                            ->setCellValue('BP' . $i, $value['formSegVta']['agreementExpires_agrr'])
                            ->setCellValue('BQ' . $i, $value['formSegVta']['price_agrr'])
                            ->setCellValue('BR' . $i, $value['formSegVta']['agreementMonthlyPayment_agrr'])
                            ->setCellValue('BS' . $i, $value['formSegVta']['agreementRi_agrr'])
                            ->setCellValue('BT' . $i, $value['formSegVta']['agreementRiDate_agrr'])
                            ->setCellValue('BU' . $i, $value['formSegVta']['referencias'][0]['name'])
                            ...
                            ->setCellValue('BY' . $i, $value['formSegVta']['referencias'][1]['name'])
