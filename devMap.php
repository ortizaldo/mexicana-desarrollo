...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                data.forEach(function(entry) {
                    user=entry.nickname;
                    locationArray.push({ lat: entry.latitude, lon: entry.longitude, zoom:8, animation:"google.maps.Animation.BOUNCE"});
                    user = entry.nickname;
    ...
    $('#btn_download:not(:disabled)').click(function () {
        ...
        var txtCompany = $('#txtCompany').val();
        console.log('txtCompany',txtCompany);
        if (txtCompany !== '' && dateFrom !== '' && inputIdUser !== '') {
