...
*/
/*** SETUP ***************************************************/
if (isset($_POST["to_tokens"]) && isset($_POST["channel"]) && isset($_POST["title"]) && isset($_POST["message"])) {
    //error_log('message entre a apiToTokens');
    $key = $APP_KEY_APPCELERATOR;
    $username = $ADMIN_USER_APPCELERATOR;
    $password = $ADMIN_PASSWORD_APPCELERATOR;
    $to_tokens = $_POST["to_tokens"];
    ...
    if (!is_null($key) && !is_null($username) && !is_null($password) && !is_null($channel) && !is_null($message) && !is_null($title)) {
        ...
        //error_log('message entre valid apiToTokens');
