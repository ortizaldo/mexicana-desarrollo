		   ...
		   // $niple = $formularioArray["id"];
			...
			if ($responseArrayInsertarFormularioTipoVentaUno["code"] == $CODE_EXITOSO) {
				...
				if ($responseFotografia["code"] == $CODE_EXITOSO) {
                                        ...
                                        $oEstructuraCarpetas->setIdReporte($idReporte);
                                        $oEstructuraCarpetas->setNumeroContrato($numeroContrato);
                                        $oEstructuraCarpetas->setFinanciado($financiado);
                                        $oEstructuraCarpetas->setTipoReporte(2);
                                        $oEstructuraCarpetas->setFecha(date("Y-m-d"));
			...
			error_log('fecha_nacimiento Despues '.$fecha_nacimiento);
