        ...
        */
        ...
        $reportsPending = $conn->prepare("
                SELECT 
                    ...
                    RP.dot_latitude, 
                    RP.dot_longitude,
                    RPH.idReportType as idReportTypeH
                    RPH.idStatusReport, 
                    RPH.idReportType, 
                    RPH.idFormSell, 
                    RPH.rechazado, 
                ...
                AND (RPH.idStatusReport=4 OR RPH.idStatusReport=7)");
            ...
            if ($reportsPending->execute()) {
                ...
                while ($reportsPending->fetch()) {
                    ...
                    error_log('idReportT '.$idReportTypeH);
                    //var_dump($idReportT);
                    $stmHistory->bind_param("iii", $idReport, $idUser, intval($idReportTypeH)); 
                    ...
                    if ($stmHistory->execute()) {
                        ...
                        while ($stmHistory->fetch()) {
                            error_log('idReportT '.$idReportT);
                            switch ($$idReportTypeH) {
                                case $TYPE_VENTA:
